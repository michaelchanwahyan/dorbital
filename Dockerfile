...
RUN cd /SOURCE ;\
    ...
    cd boost_1_61_0 ; ./bootstrap.sh ; ./b2 install -j2
...
RUN cd /SOURCE ;\
    ...
    cd eigen_3_2_8 ; mkdir build ; cd build ; cmake .. ; make -j2 ; make install
...
RUN cd /SOURCE ;\
    ...
    cd flann_1_8_4 ; mkdir build ; cd build ; cmake .. ; make -j2 ; make install
...
RUN cd /SOURCE ;\
    ...
    cd vtk_7_0_0 ; mkdir build ; cd build ; cmake .. ; make -j2 ; make install
